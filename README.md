PhishX - Phishing Detection Chrome Extension using Machine Learning
...
📂 Project Structure 📁 frontend/ – Chrome extension frontend (HTML + JS) 📁 backend/ – Python backend with FastAPI and XGBoost model
...
🛠️ Technologies Used Machine Learning: XGBoost, Scikit-learn
...
🧪 How It Works The user visits a website.
...
🎓 Project Context This extension is the implementation part of a project on phishing detection using machine learning. The goal is to build a practical, scalable solution for securing users against phishing attacks during regular browsing.
